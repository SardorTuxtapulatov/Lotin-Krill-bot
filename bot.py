...
async def start_command(message:Message):
    ...
    try:
        ...
        await message.answer(text="Assalomu alaykum, botimizga hush kelibsiz bizning bot Lotin harfdagi so'zlarni Kril ga o'zgartiradi,\nKrill so'zlarni Lotinga o'zgartirib beradi.")
    except:
        await message.answer(text="Assalomu alaykum, bot Lotin harfdagi so'zlarni Kril ga o'zgartiradi,\nKrill so'zlarni Lotinga o'zgartirib beradi.")
